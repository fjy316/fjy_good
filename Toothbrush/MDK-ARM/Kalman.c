...
//float Q_bias;         //陀螺仪的偏差
//float K_0, K_1;       //卡尔曼增益 K_0:用于计算最优值 K_1:用于计算最优估计值的偏差
//float PP[2][2] = { { 1, 0 },{ 0, 1 } };//过程协方差矩阵P，初始值为单位阵
...
//	static float K_0, K_1;       //卡尔曼增益 K_0:用于计算最优值 K_1:用于计算最优估计值的偏差
